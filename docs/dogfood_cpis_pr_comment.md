...
**分支**: `main`
**生成时间**: 2026-06-23T11:13:20.814826+00:00
---
...
🔴 **状态**: 禁止合并 🔴
  ...
  - 🚫 BLOCKED: Critical: verify-deploy.sh (level=critical)
...
- **通过**: 0
- **失败**: 0
- **包 ID**: `pack_05e6f92bd719`

## Reviewer Action Items

- 🔴 紧急: 解决阻塞问题后再合并
  - *合并就绪度为 block，存在 8 个阻塞项*
...
- 🔴 紧急: 处理阻塞问题: BLOCKED: High-risk changes in 'openclaw-plugins' (level=high)
  - *该问题阻止安全合并*

- 🔴 紧急: 处理阻塞问题: BLOCKED: High-risk changes in 'scripts' (level=high)
  - *该问题阻止安全合并*
